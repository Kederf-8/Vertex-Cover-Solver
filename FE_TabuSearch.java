...
// TabuSearch.java alternativo che usa come criterio di terminazione il numero di funzioni obiettivo valutate
...
public class FE_TabuSearch {
    ...
    public FE_TabuSearch(Graph graph, int maxIterations, int tabuTenure, int maxNoImprovement) {
        this.graph = graph;
